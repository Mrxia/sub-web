<template>
  <div class="glass-container">
    ...
    <el-dialog :visible.sync="dialogUploadConfigVisible" :modal="false" :lock-scroll="false" :close-on-click-modal="true"
               :close-on-press-escape="true" :show-close="true" width="700px">
      <div slot="title">
    ...
    <el-dialog :visible.sync="dialogLoadConfigVisible" :modal="false" :lock-scroll="false" :close-on-click-modal="true"
               :close-on-press-escape="true" :show-close="true" width="700px">
      <div slot="title">
        解析 Subconverter 链接
      </div>
